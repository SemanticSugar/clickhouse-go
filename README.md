# ClickHouse [![Build Status](https://travis-ci.org/ClickHouse/clickhouse-go.svg?branch=master)](https://travis-ci.org/ClickHouse/clickhouse-go) [![Go Report Card](https://goreportcard.com/badge/github.com/SemanticSugar/clickhouse-go)](https://goreportcard.com/report/github.com/SemanticSugar/clickhouse-go) [![codecov](https://codecov.io/gh/ClickHouse/clickhouse-go/branch/master/graph/badge.svg)](https://codecov.io/gh/ClickHouse/clickhouse-go)
...
* UUID
* Nullable(T)
* [Array(T) (one-dimensional)](https://clickhouse.yandex/reference_en.html#Array(T)) [godoc](https://godoc.org/github.com/SemanticSugar/clickhouse-go#Array)
...
## Install
```
go get -u github.com/SemanticSugar/clickhouse-go
```
...
import (
	...
	_ "github.com/SemanticSugar/clickhouse-go"
)
